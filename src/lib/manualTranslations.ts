...
const phraseRecords: PhraseRecord[] = [
  ...
  { pt: 'CONTRATO', en: 'CONTRACT', es: 'CONTRATO' },
  { pt: 'Quando é obrigatório contrato', en: 'When a contract is required', es: 'Cuándo es obligatorio el contrato' },
  { pt: 'Vendas acima de 2k (mesmo que tenha sido pendência, vai o valor total da pendência).', en: 'Sales above 2k (even if it was a pending payment, the full pending amount counts).', es: 'Ventas superiores a 2k (aunque haya sido una pendencia, cuenta el valor total de la pendencia).' },
  { pt: 'Vendas de big clientes.', en: 'Sales to big clients.', es: 'Ventas de clientes grandes.' },
  { pt: 'Caso o cliente não assine em até 24h, o vendedor perderá a venda.', en: 'If the client does not sign within 24h, the seller will lose the sale.', es: 'Si el cliente no firma dentro de 24h, el vendedor perderá la venta.' },
  ...
  { pt: 'Receber pagamento de cliente no Pix pessoal', en: 'Receive client payment through personal Pix', es: 'Recibir pago de cliente en Pix personal' },
  ...
  { pt: 'Não pode estar associado a uma Facção/Organização', en: 'Cannot be associated with a Faction/Organization', es: 'No puede estar asociado a una Facción/Organización' },
...
Si el afiliado es removido del equipo, sale por cuenta propia o deja de formar parte del programa antes de utilizar el saldo, el cashback se perderá automáticamente y no podrá recuperarse.`,
  ...
  {
    pt: `# 🚨 AVISO IMPORTANTE — PAGAMENTOS
...
**Não haverá** justificativa, atenuante ou segunda chance. O recebimento de qualquer valor de cliente em conta pessoal será tratado como **infração gravíssima**.`,
    en: `# 🚨 IMPORTANT NOTICE — PAYMENTS

It is **strictly forbidden** for any **seller** or **affiliate** to receive client money through their **personal Pix**, no matter the reason.

### 📌 WHAT IS FORBIDDEN

- Receiving money in a personal Pix to **make payments** on behalf of the client
- **Handling purchases** using your own account
- Any other financial movement involving the client outside the official payment methods

### ✅ AUTHORIZED OFFICIAL METHODS

Every payment must be made **exclusively** through:

- 🟢 **HUB**
- 🟢 **TEBEX**
- 🟢 **REVOLUT**

### ⚖️ IMMEDIATE PUNISHMENT

> 🔴 **Affiliate:** global ban from the entire **Santa Group**, preventing them from joining any team or city.

> 🔴 **Seller:** **immediate dismissal**.

### ⚠️ NO EXCEPTIONS

There will be **no** justification, reduced penalty or second chance. Receiving any client money in a personal account will be treated as a **very serious violation**.`,
    es: `# 🚨 AVISO IMPORTANTE — PAGOS

Está **terminantemente prohibido** que cualquier **vendedor** o **afiliado** reciba dinero de clientes en su **Pix personal**, sea cual sea el motivo.

### 📌 LO QUE ESTÁ PROHIBIDO

- Recibir valores en el Pix personal para **realizar pagos** en nombre del cliente
- **Intermediar compras** usando una cuenta propia
- Cualquier otro movimiento financiero con el cliente fuera de los medios oficiales

### ✅ MEDIOS OFICIALES AUTORIZADOS

Todo pago debe hacerse **exclusivamente** por:
...
> 🔴 **Afiliado:** ban global de todo **Santa Group**, quedando impedido de participar en cualquier equipo o ciudad.

> 🔴 **Vendedor:** **despido inmediato**.

### ⚠️ SIN EXCEPCIONES

**No habrá** justificación, atenuante ni segunda oportunidad. Recibir cualquier valor de cliente en una cuenta personal será tratado como una **infracción gravísima**.`,
  },
  {
...
> Abusar de Poder es usar tus poderes para beneficio propio, y no para ventas`,
  ...
  {
    pt: `**Não pode estar associado a uma Facção/Organização** porque o vendedor precisa ser visto como alguém neutro dentro da cidade.
...
> Vendedor tem que ser neutro. Pode conversar, fazer amizade e circular pelos lugares, mas não pode carregar bandeira de nenhuma facção ou organização.`,
    en: `**Cannot be associated with a Faction/Organization** because the seller needs to be seen as someone neutral inside the city.

👉 If you are linked to a faction or organization, many people may look at it the wrong way and think you will favor that group, talk more with people you already know, or mix sales with RP interests.

### 📌 Why does this look bad?

- The client may think you are defending one side.
- Other groups may distrust your service.
- The sale may look like favoritism, even when you are doing everything correctly.
- The seller loses that image of being impartial and treating everyone the same way.

### 🎯 Simple summary:

> A seller has to be neutral. You can talk, make friends and move around the city, but you cannot carry the flag of any faction or organization.`,
    es: `**No puede estar asociado a una Facción/Organización** porque el vendedor necesita ser visto como alguien neutral dentro de la ciudad.

👉 Si estás vinculado a una facción u organización, mucha gente puede verlo mal y pensar que vas a favorecer a ese grupo, hablar más con conocidos o mezclar la venta con intereses dentro del RP.

### 📌 ¿Por qué se ve mal?

- El cliente puede pensar que estás defendiendo un lado.
- Otros grupos pueden desconfiar de tu atención.
- La venta puede parecer favoritismo, incluso cuando estás haciendo todo correctamente.
- El vendedor pierde esa imagen de persona imparcial, que atiende a todos de la misma manera.

### 🎯 Resumen simple:

> El vendedor tiene que ser neutral. Puede conversar, hacer amistades y circular por la ciudad, pero no puede cargar la bandera de ninguna facción u organización.`,
  },
